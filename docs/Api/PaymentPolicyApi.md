...
```php
createPaymentPolicy($payment_policy_request): \eBay\Sell\Account\Model\SetPaymentPolicyResponse
```
...
$payment_policy_request = new \eBay\Sell\Account\Model\PaymentPolicyRequest(); // \eBay\Sell\Account\Model\PaymentPolicyRequest | Payment policy request
...
------------- | ------------- | ------------- | -------------
 **payment_policy_request** | [**\eBay\Sell\Account\Model\PaymentPolicyRequest**](../Model/PaymentPolicyRequest.md)| Payment policy request |
...
```php
updatePaymentPolicy($payment_policy_id, $payment_policy_request): \eBay\Sell\Account\Model\SetPaymentPolicyResponse
```
