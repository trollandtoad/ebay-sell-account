...
```php
createReturnPolicy($return_policy_request): \eBay\Sell\Account\Model\SetReturnPolicyResponse
```
...
$return_policy_request = new \eBay\Sell\Account\Model\ReturnPolicyRequest(); // \eBay\Sell\Account\Model\ReturnPolicyRequest | Return policy request
...
------------- | ------------- | ------------- | -------------
 **return_policy_request** | [**\eBay\Sell\Account\Model\ReturnPolicyRequest**](../Model/ReturnPolicyRequest.md)| Return policy request |
...
```php
updateReturnPolicy($return_policy_id, $return_policy_request): \eBay\Sell\Account\Model\SetReturnPolicyResponse
```
...
$return_policy_request = new \eBay\Sell\Account\Model\ReturnPolicyRequest(); // \eBay\Sell\Account\Model\ReturnPolicyRequest | Container for a return policy request.
 ...
 **return_policy_request** | [**\eBay\Sell\Account\Model\ReturnPolicyRequest**](../Model/ReturnPolicyRequest.md)| Container for a return policy request. |
