...
$sales_tax_base = new \eBay\Sell\Account\Model\SalesTaxBase(); // \eBay\Sell\Account\Model\SalesTaxBase | A container that describes the how the sales tax is calculated.
 ...
 **sales_tax_base** | [**\eBay\Sell\Account\Model\SalesTaxBase**](../Model/SalesTaxBase.md)| A container that describes the how the sales tax is calculated. |
