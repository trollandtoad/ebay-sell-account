...
$program = new \eBay\Sell\Account\Model\Program(); // \eBay\Sell\Account\Model\Program | Program being opted-in to.
...
------------- | ------------- | ------------- | -------------
 **program** | [**\eBay\Sell\Account\Model\Program**](../Model/Program.md)| Program being opted-in to. |
...
$program = new \eBay\Sell\Account\Model\Program(); // \eBay\Sell\Account\Model\Program | Program being opted-out of.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **program** | [**\eBay\Sell\Account\Model\Program**](../Model/Program.md)| Program being opted-out of. |
